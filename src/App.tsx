            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
              <Reveal delay={0}>
                <div className="glass halo rounded-2xl p-7 flex flex-col gap-4 relative overflow-hidden min-h-[240px]">
                  ...
                  <p className="text-sm text-muted-foreground">Tell us your niche and city. Our pipeline scrapes, validates, enriches, and delivers 500 decision-maker contacts in CSV — straight to your browser and inbox.</p>
